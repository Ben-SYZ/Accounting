...
Dim data(1000) As Transaction '放数据


Dim i_prt As Integer '每一行记录的i
Dim num As Integer '当前打印中的总号

Dim nextpage As Single '三表一换
...
Private Function PRTwords(i_prt_words As Single) 'i 控制一行字一行字地下来
    While data(i_prt).num = num
        ...
        Dim flag As Boolean '判断0在前面还是后面
        flag = False
        For i = 0 To 8
